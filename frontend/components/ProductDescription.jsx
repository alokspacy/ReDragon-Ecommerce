        ...
        <div className="my-18 text-sm text-slate-600">
            ...
            {selectedTab === "Reviews" && (
                <div className="flex flex-col gap-3 mt-14">
                    {product.rating && product.rating.map((item,index) => (
                        <div key={index} className="flex gap-5 mb-10">
                            <Image src={api.imageUrl(item.user.image)} alt="" className="size-10 rounded-full" width={100} height={100} />
                            <div>
            ...
            <div className="flex gap-3 mt-14">
                {product.store && product.store.logo && (
                    <Image src={api.imageUrl(product.store.logo)} alt="" className="size-11 rounded-full ring ring-slate-400" width={100} height={100} />
                )}
                <div>
